  ...
  return (
    <div className="flex">
      ...
      <main className="min-h-screen flex-1 bg-[#faf9f4] p-8 pt-20 sm:p-12 sm:pt-12 dark:bg-slate-950">
        ...
        {showModal && (
          <form onSubmit={handleCreate} className="mb-6 flex max-w-xl gap-2 rounded-2xl border border-[#e5e4dc] bg-white p-3">
            <input
              autoFocus
              value={title}
        ...
        {boards.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-[#cfd8d0] bg-white/60 px-6 py-16 text-center">
            <p className="display-font text-2xl text-[#5e7664]">A fresh page awaits.</p>
            <p className="mt-2 text-sm text-[#8b897f]">No boards yet — create your first one.</p>
          </div>
        ) : (
